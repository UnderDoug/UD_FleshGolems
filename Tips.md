...
### Options
There are 4 options that let the player dynamically fiddle with the "Reanimated" and "Animated" builders. Each builder has a base ChanceOneIn and multiplier. The lower the numbers the more likely they are to be applied, with 0 disabling them altogether.

It's entirely possible to play as a reanimated player in this way.
